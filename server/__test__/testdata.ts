...
const testGeneratedQuestionData: GeneratedQuestionDataResDTO[] = [
  {
    lQuestionID: 'listening-part1-A7B8C9D1',
  ...
  {
    lQuestionID: 'listening-part2-B3F7A9E2',
  ...
  {
    lQuestionID: 'listening-part3-C5E1F8G3',
  ...
  {
    lQuestionID: 'listening-part4-D9A4B7C2',
  ...
  {
    lQuestionID: 'listening-part2-E8F2G1H4',
...
const testAudioURLList: AudioURL[] = [
  { lQuestionID: 'listening-part1-A7B8C9D1', audioURL: 'https://example.com/audio/part1-001.mp3' },
  { lQuestionID: 'listening-part2-B3F7A9E2', audioURL: 'https://example.com/audio/part2-047.mp3' },
  { lQuestionID: 'listening-part3-C5E1F8G3', audioURL: 'https://example.com/audio/part3-078.mp3' },
  { lQuestionID: 'listening-part4-D9A4B7C2', audioURL: 'https://example.com/audio/part4-112.mp3' },
  { lQuestionID: 'listening-part2-E8F2G1H4', audioURL: 'https://example.com/audio/part2-089.mp3' }
];
